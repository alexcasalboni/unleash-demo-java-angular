      ...
      <div class="bg-white dark:bg-gray-800 p-8 mb-8 rounded-lg shadow-xl border-t-4 border-unleash dark:border-blue-500 transition-colors">
        <h2 class="text-2xl text-unleash dark:text-blue-400 mb-4 font-semibold transition-colors">
          ...
          @if (reportsKillSwitchActive()) {
            <div class="bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-500 p-6 rounded mb-4 transition-colors">
              <div class="flex items-center gap-3 mb-2">
                <span class="text-2xl">⚠️</span>
                <h3 class="text-yellow-800 dark:text-yellow-300 font-semibold text-lg m-0 transition-colors">
                  Warning: Data Might Be Obsolete
                </h3>
              </div>
              <p class="text-yellow-700 dark:text-yellow-400 m-0 transition-colors">
            ...
            <table class="w-full border-collapse">
              ...
              <tbody>
                <tr class="border-b border-gray-200 dark:border-gray-700 transition-colors">
                  <td class="p-4 text-gray-800 dark:text-gray-300 transition-colors">disable-slow-reports</td>
                  <td class="p-4 transition-colors">
                    <span class="px-3 py-1 rounded-full text-sm font-semibold bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200">
                      kill-switch
                    </span>
                  </td>
                  <td class="p-4 text-gray-800 dark:text-gray-300 transition-colors">
                    Emergency toggle to immediately reduce load from slow operations without redeploying. When active, the backend returns cached results instantly instead of performing the slow operation, providing graceful degradation while keeping the feature accessible.
                  </td>
                </tr>
              </tbody>
            </table>
