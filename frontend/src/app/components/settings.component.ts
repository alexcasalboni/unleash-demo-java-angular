        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center">
          <div class="flex items-center gap-8">
            ...
            <div class="flex gap-6">
              ...
              <a routerLink="/settings" class="text-white no-underline px-4 py-2 rounded transition-colors bg-white/10 hover:bg-white/20">Settings</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div class="max-w-7xl mx-auto px-8 py-12">
        ...
        <div class="text-center mb-12">
          <h1 class="text-4xl text-unleash mb-2 font-bold">
            Unleash Demo (Settings)
          </h1>
          <p class="text-gray-600 text-lg">
            Configuration and settings for the demo application
          </p>
        </div>
