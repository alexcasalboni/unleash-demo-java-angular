        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center">
          <div class="flex items-center gap-8">
            ...
            <div class="flex gap-6">
              ...
              <a routerLink="/gradual-rollout" class="text-white no-underline px-4 py-2 rounded transition-colors bg-white/10 hover:bg-white/20">Gradual Rollout</a>
...
export class GradualRolloutComponent {}
